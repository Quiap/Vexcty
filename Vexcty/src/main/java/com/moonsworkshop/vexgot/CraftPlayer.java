...
public class CraftPlayer extends CraftHumanEntity implements VexctyPlayer {
    ...
    private final VexctyPlayer.Spigot spigot = new VexctyPlayer.Spigot() {
        ...
        public Set<VexctyPlayer> getHiddenPlayers() {
            Set<VexctyPlayer> ret = new HashSet();
            Iterator var2 = CraftPlayer.this.hiddenPlayers.iterator();

            while(var2.hasNext()) {
                UUID u = (UUID)var2.next();
                ret.add((VexctyPlayer) CraftPlayer.this.getServer().getPlayer(u));
            }
    ...
    public void removeDisconnectingPlayer(VexctyPlayer player) {
        this.hiddenPlayers.remove(player.getUniqueId());
    }
    ...
    public VexctyPlayer.Spigot spigot() {
        return this.spigot;
    }
}
